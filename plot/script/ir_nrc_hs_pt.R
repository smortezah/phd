...
setwd("./")
file_in_a <- "../data/ir_hs_pt.tsv"
file_in_b <- "../data/ir_diff_hs_pt.tsv"
file_in_c <- "../data/ir_pt_hs.tsv"
file_in_d <- "../data/ir_diff_pt_hs.tsv"
file_out <- "../image/ir_hs_pt.png"
...
ggsave(file_out, height = 20, width = 16)
